        ...
        <>
            <div className="container mx-auto px-4 py-8 mt-16 bg-[#1b1f2b] rounded-lg flex ">
                ...
                <div className="md:w-2/3 p-6">
                    ...
                    <div className="text-gray-400 mt-7 text-2xl"> 
                        {details.overview}
                    </div>
                    <p className="mt-7 text-gray-500">Language : {details.original_language}</p>
                    {/* votes */}
                    ...
                    <IoPlayBackCircle className="text-4xl text-gray-200"  onClick={()=> navigate(-1)}/>
