  ...
  return (
    ...
    hover:shadow-lg hover:shadow-black transition-all duration-300 group '>
     <div className='relative overflow-hidden'>
      ...
      <IoHeartCircleSharp className='text-white absolute top-2 right-2 text-2xl
       opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10'  onClick={()=>onAddfavor()}/>
      </div>
